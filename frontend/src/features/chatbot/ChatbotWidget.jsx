                ...
                {QUICK_MESSAGES.map((message) => (
                  <button
                    ...
                    className={isMobilePage
                      ...
                      : 'rounded border border-slate-700 px-2.5 py-1.5 text-[11px] font-bold text-slate-300 transition hover:border-ai-cyan hover:text-ai-cyan disabled:opacity-50'}
                  >
                    {message}
                  </button>
                ))}
